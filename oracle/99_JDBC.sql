...
CREATE TABLE TB_BOOK(
    ...
    CONSTRAINT TB_BOOK_OK_NO_PK PRIMARY KEY(BK_NO)
);
DELETE FROM TB_BOOK WHERE BK_NO =0;
INSERT INTO TB_BOOK VALUES(0, '문병철의투자법', '문병철');
SELECT * FROM TB_BOOK;
...
COMMIT; -- **** Oracle은 반드시 필수
COMMIT; -- **** Oracle은 반드시 필수
COMMIT; -- **** Oracle은 반드시 필수COMMIT; -- **** Oracle은 반드시 필수COMMIT; -- **** Oracle은 반드시 필수
COMMIT; -- **** Oracle은 반드시 필수
COMMIT; -- **** Oracle은 반드시 필수
COMMIT; -- **** Oracle은 반드시 필수COMMIT; -- **** Oracle은 반드시 필수v
COMMIT; -- **** Oracle은 반드시 필수
COMMIT; -- **** Oracle은 반드시 필수
COMMIT; -- **** Oracle은 반드시 필수COMMIT; -- **** Oracle은 반드시 필수